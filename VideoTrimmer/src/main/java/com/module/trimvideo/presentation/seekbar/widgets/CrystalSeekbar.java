package com.module.trimvideo.presentation.seekbar.widgets;
...
import com.module.trimvideo.presentation.seekbar.interfaces.OnSeekbarChangeListener;
import com.module.trimvideo.presentation.seekbar.interfaces.OnSeekbarFinalValueListener;
...
public class CrystalSeekbar extends View {
    ...
    public Number getSelectedMinValue() {
        ...
        if (steps > 0 && steps <= ((absoluteMaxValue) / 2)) {
            ...
            if (steps != NO_STEP) throw new IllegalStateException("steps out of range " + steps);
        }
    ...
    protected void setupBar(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        if (barColorMode == ColorMode.SOLID) {
            ...
            paint.setShader(new LinearGradient(rect.left, rect.bottom, rect.right, rect.top, barGradientStart, barGradientEnd, Shader.TileMode.MIRROR));
    ...
    protected void setupHighlightBar(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        if (barHighlightColorMode == ColorMode.SOLID) {
            ...
            paint.setShader(new LinearGradient(rect.left, rect.bottom, rect.right, rect.top, barHighlightGradientStart, barHighlightGradientEnd, Shader.TileMode.MIRROR));
